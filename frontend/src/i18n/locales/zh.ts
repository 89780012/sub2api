export default {
  ...
  usage: {
    ...
    selectionCompare: '比较明细',
    selectionSummary: '摘要',
    selectionRule: '规则',
    selectionAccount: '选择依据账号',
    selectionFinalAccount: '最终路由账号',
    selectionEndpoint: 'URL',
    selectionCandidates: '候选数',
    selectionCandidatesCompared: '纳入比较的账号',
    selectionTopK: 'Top K',
    selectionLoadSkew: '负载偏斜',
    selectionMonitorMatched: '监控匹配',
    selectionMonitorNotMatched: '未匹配监控',
    selectionMonitor: '匹配监控',
    selectionMonitorPrimaryModel: '监控模型',
    selectionSnapshotAt: '选择快照时间',
    selectionMonitor3: '监控 3 根',
    selectionMonitor5: '监控 5 根',
    selectionMonitor7: '监控 7 根',
    selectionMonitorRecent7: '选择时最近 7 根',
    selectionMonitorOrder: '排序',
    selectionLatestFirst: '最新在前',
    selectionLoad: '负载',
    selectionLoadRate: '负载率',
    selectionConcurrency: '并发',
    selectionWaiting: '等待',
    selectionWaitPlan: '等待方案',
    selectionTimeoutMs: '超时 ms',
    selectionMaxWaiting: '最大等待',
    selectionTieBreakerLabel: '同分依据',
    monitorGreen: '绿',
    monitorOrange: '橙',
    monitorRed: '红',
    monitorUnknown: '未知',
    ...
    no: '否',
    selectionRules: {
      monitorQualityPriorityLoadLru: '监控质量 > 优先级 > 负载 > LRU',
      monitorQualityPriorityLru: '监控质量 > 优先级 > LRU',
      sticky: '粘性绑定',
      openaiAdvancedScheduler: 'OpenAI 高级调度',
      legacyOrder: '监控质量 > 优先级/LRU 旧排序',
    },
    selectionTieBreakers: {
      monitorQuality357: '监控 3/5/7',
      lru: 'LRU',
    },
