  ...
  admin: {
    ...
    accounts: {
      ...
      balanceSync: {
        ...
        refreshAll: '刷新全部',
        refreshSite: '刷新站点',
        refreshQueued: '余额刷新已完成',
        refreshFailed: '余额刷新失败',
        loadFailed: '加载余额同步数据失败',
        platform: '平台',
        baseUrl: 'Base URL',
        authMode: '认证模式',
        authModePassword: '账号密码',
        authModeAccessToken: '访问 Token',
        authModeCookie: 'Cookie',
        username: '用户名',
        enabled: '启用自动刷新',
        refreshInterval: '刷新间隔（分钟）',
        passwordConfigured: '已配置密码',
        passwordKeepHint: '留空则保持当前密码',
        accessToken: '访问 Token',
        accessTokenConfigured: '已配置 Token',
        accessTokenKeepHint: '留空则保持当前 Token',
        cookie: 'Cookie',
        cookieConfigured: '已配置 Cookie',
        cookieKeepHint: '留空则保持当前 Cookie',
        snapshots: '最新快照',
        snapshotCount: '{count} 条快照',
        allSites: '全部站点',
        key: '密钥',
        accountBalance: '账号余额',
        packageBalance: '套餐余额',
        ...
        bind: '绑定',
        clearBinding: '解除',
        bindingUpdated: '余额绑定已更新',
        bindingCleared: '余额绑定已解除',
        emptySnapshots: '暂无快照',
        notRefreshed: '尚未刷新',
        unlimited: '无限制',
        dailyShort: '日',
