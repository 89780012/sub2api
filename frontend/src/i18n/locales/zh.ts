  ...
  admin: {
    ...
    groups: {
      ...
      qualityPanel: {
        ...
        rankReasons: {
          ...
          lowerPriority: '这个账号的优先级更低，所以在当前分组里会排在更高优先级账号后面。',
          ...
          recentlyUsed: '前面的条件已经很接近了，所以最近刚用过的账号会排在更久没用的账号后面。',
        ...
        primaryBypassReasons: {
          ...
          primary_model_mismatch: '主账号不支持本次请求的模型',
          primary_endpoint_capability_mismatch: '主账号不支持本次请求的接口类型',
          primary_compact_unsupported: '主账号不支持 Responses compact 调度',
        ...
        errorRateLabel: '错误率 {value}',
        fastBonusLabel: '快速加分 {value}',
        slowPenaltyLabel: '慢响应扣分 {value}',
        errorPenaltyLabel: '错误扣分 {value}',
        baseLabel: '基线 {value}',
        baseQualityLabel: '基础质量分 {value}',
        effectiveLabel: '最终调度分 {value}',
        transientPenaltyLabel: '临时扣分 {value}',
        slowStreakLabel: '连续慢响应 {value}',
        errorStreakLabel: '连续错误 {value}',
        recoverySuccessLabel: '恢复成功 {value}',
        recoveryFastLabel: '恢复快速 {value}',
        recoveryCreditLabel: '恢复抵扣 {value}',
        appliedPenaltyLabel: '实际扣分 {value}',
        totalRequestsLabel: '总请求 {value}',
        totalRequestsShort: '请求数',
        failureRequestsLabel: '失败 {value}',
        ttftSamplesLabel: 'TTFT 样本 {value}',
        ttftSamplesShort: 'TTFT 样本',
        confidenceLabel: '置信度 {value}',
        successComponentLabel: '成功率加分 {value}',
        auxRequestsLabel: '辅助请求 {value}',
        auxFailuresLabel: '辅助失败 {value}',
        auxTTFTLabel: '辅助 TTFT {value}',
        auxWeightLabel: '辅助权重 {value}',
        slowStreakShort: '连续慢',
        errorStreakShort: '连续错误',
        breakdownTitle: '基础质量分构成',
        recoveryTitle: '扣分与恢复',
        auxiliaryTitle: '辅助样本',
        formulaTitle: '调度明细',
        ttft5sLabel: '5s 内加分 {value}',
        ttft10sLabel: '5~10s 加分 {value}',
        fast5sRateLabel: '5s 内比例 {value}',
        fast10sRateLabel: '10s 内比例 {value}',
        slow20sRateLabel: '20s+ 比例 {value}',
        slow40sRateLabel: '40s+ 比例 {value}',
        signalFast5s: '5s 内 {value}',
        signalSlow10s: '10s+ {value}',
        signalErrorRate: '错误 {value}',
        signalSuccessRate: '成功率 {value}',
        signalPenalty: '实际扣分 {value}',
        signalRecovery: '恢复抵扣 {value}',
        signalAuxWeight: '辅助权重 {value}'
      },
    ...
    accounts: {
      ...
      upstreamMonitor: {
        ...
        noTime: '无时间',
        refresh: '刷新上游监控',
        refreshSuccess: '上游监控已刷新',
        refreshFailed: '刷新上游监控失败'
      },
      upstreamMonitorConfig: {
        title: '上游监控',
        hint: '只读采集余额和分组倍率，独立于推理 Base URL 和 API Key。',
        enabled: '启用',
        provider: '类型',
        siteUrl: '监控站点 URL',
        siteUrlHint: '填写 NewAPI/Sub2API 站点根地址，不是 OpenAI 兼容的 /v1 推理端点。',
        newapiUserId: 'NewAPI 用户 ID',
        newapiCookie: 'NewAPI Cookie',
        sub2apiAccessToken: 'Sub2API Access Token',
        siteUrlRequired: '请填写监控站点 URL',
        newapiUserRequired: '请填写 NewAPI 用户 ID',
        newapiCookieRequired: '请填写 NewAPI Cookie',
        sub2apiTokenRequired: '请填写 Sub2API Access Token'
      },
    ...
    usage: {
      ...
      scheduleDetail: '调度详情',
      scheduleReason: '原因',
      scheduleCandidates: '候选数',
      schedulePriority: '优先级',
      scheduleRecentSuccessRate: '近5分钟成功率',
      scheduleTtft5s: '首 Token ≤5秒',
      scheduleTtft10s: '首 Token ≤10秒',
      scheduleTtftGt10s: '首 Token >10秒',
      scheduleTtftGt20s: '首 Token >20秒',
      scheduleTtftGt40s: '首 Token >40秒',
      scheduleQualityScore: '质量分',
      scheduleLoadRate: '负载率',
      scheduleErrorRate: '错误率',
      scheduleSampleConfidence: '置信度',
      scheduleFastBonus: '快响应加分',
      scheduleSlowPenalty: '慢响应扣分',
      scheduleErrorPenalty: '错误扣分',
      scheduleNeutralBase: '中性基线',
      scheduleFormula: '公式',
      scheduleFinalScore: '最终分',
      scheduleCandidateScores: '候选分数拆解',
      scheduleSelected: '已选中',
      scheduleComputedScore: '计算分',
      scheduleScoreBreakdown: '分数拆解',
      scheduleWaitingCount: '等待数',
      scheduleTtftSampleCount: 'TTFT样本',
      scheduleTotalRequests: '请求数',
      scheduleFailureRequests: '失败数',
      scheduleStickyEscape: '粘性逃逸',
      scheduleSticky: '粘性',
      scheduleRouting: '路由',
      scheduleQuality: '质量',
      scheduleFallback: '排队',
      ...
      scheduleDecision: {
        ...
        primarySelected: '主账号符合条件，直接命中：{account}',
        primarySkipped: '跳过主账号：{account}，原因：{reason}',
        stickySelected: '命中 sticky 会话：{account}',
        loadBalanceCandidates: '进入负载均衡候选顺序：{candidates}',
        loadBalanceNoCandidates: '进入负载均衡候选，但这条调度日志没有记录候选顺序',
        candidateSelected: '{account}（命中）',
        finalSelected: '最终命中账号：{account}'
