  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamMonitorConfig: {
        ...
        hint: 'Read-only balance and group-rate collection. This is separate from the inference Base URL and API Key.',
        enabled: 'Enable',
        provider: 'Provider',
        siteUrl: 'Monitor site URL',
        siteUrlHint: 'Use the NewAPI/Sub2API site root, not the OpenAI-compatible /v1 inference endpoint.',
        newapiUserId: 'NewAPI User ID',
        newapiCookie: 'NewAPI Cookie',
        sub2apiAccessToken: 'Sub2API Access Token',
        siteUrlRequired: 'Monitor site URL is required',
        newapiUserRequired: 'NewAPI User ID is required',
        newapiCookieRequired: 'NewAPI Cookie is required',
        sub2apiTokenRequired: 'Sub2API Access Token is required'
      },
