export default {
  ...
  usage: {
    ...
    endpoint: 'Endpoint',
    selectionReason: 'Selection Basis',
    selectionCompare: 'Selection Compare',
    selectionSummary: 'Summary',
    selectionRule: 'Rule',
    selectionAccount: 'Account',
    selectionFinalAccount: 'Final Routed Account',
    selectionEndpoint: 'Endpoint',
    selectionCandidates: 'Candidates',
    selectionCandidatesCompared: 'Compared Accounts',
    selectionTopK: 'Top K',
    selectionLoadSkew: 'Load skew',
    selectionMonitorMatched: 'Monitor matched',
    selectionMonitorNotMatched: 'monitor not matched',
    selectionMonitor: 'Matched monitor',
    selectionMonitorPrimaryModel: 'Monitor model',
    selectionSnapshotAt: 'Selection snapshot',
    selectionMonitor3: 'Monitor 3',
    selectionMonitor5: 'Monitor 5',
    selectionMonitor7: 'Monitor 7',
    selectionMonitorRecent7: 'Selection-time recent 7',
    selectionMonitorOrder: 'Order',
    selectionLatestFirst: 'Latest first',
    selectionLoad: 'Load',
    selectionLoadRate: 'Load rate',
    selectionConcurrency: 'Concurrency',
    selectionWaiting: 'Waiting',
    selectionWaitPlan: 'Wait plan',
    selectionTimeoutMs: 'Timeout ms',
    selectionMaxWaiting: 'Max waiting',
    selectionTieBreakerLabel: 'Tie-breakers',
    monitorGreen: 'Green',
    monitorOrange: 'Orange',
    monitorRed: 'Red',
    ...
    no: 'No',
    selectionRules: {
      monitorQualityPriorityLoadLru: 'Monitor quality > priority > load > LRU',
      monitorQualityPriorityLru: 'Monitor quality > priority > LRU',
      sticky: 'Sticky binding',
      openaiAdvancedScheduler: 'OpenAI advanced scheduler',
      legacyOrder: 'Monitor quality > priority/LRU legacy order',
    },
    selectionTieBreakers: {
      monitorQuality357: 'Monitor 3/5/7',
      lru: 'LRU',
    },
