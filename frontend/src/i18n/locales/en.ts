  ...
  admin: {
    ...
    groups: {
      ...
      qualityPanel: {
        ...
        description: 'See which accounts are currently easier to pick first, then inspect what is dragging them down.',
        selectionHint: 'Sorting follows current effective score first. When scores are close, lower applied penalty and stronger recovery are shown earlier.',
        ...
        baseQualityLabel: 'Base quality {value}',
