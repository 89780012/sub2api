  ...
  admin: {
    ...
    groups: {
      ...
      qualityPanel: {
        ...
        empty: 'No account quality data for this group',
        failedToLoad: 'Failed to load group quality panel',
        known: 'Known',
        unknown: 'Unknown',
        unschedulable: 'Unschedulable',
        columns: {
          account: 'Account',
          score: 'Final Schedule Score',
          risk: 'Risk Signals',
          samples: 'Samples',
        ...
        rankReasons: {
          ...
          lowerPriority: 'Its account priority is lower, so the scheduler will place it behind higher-priority accounts in this group.',
          ...
          recentlyUsed: 'Earlier factors are close, so a more recently used account is placed after the less recently used ones.',
        ...
        primaryBypassReasons: {
          ...
          primary_model_mismatch: 'primary account does not support the requested model',
          primary_endpoint_capability_mismatch: 'primary account does not support this endpoint type',
          primary_compact_unsupported: 'primary account does not support Responses compact scheduling',
        ...
        errorRateLabel: 'Error rate {value}',
        fastBonusLabel: 'Fast bonus {value}',
        slowPenaltyLabel: 'Slow penalty {value}',
        errorPenaltyLabel: 'Error penalty {value}',
        baseLabel: 'Base {value}',
        baseQualityLabel: 'Base quality score {value}',
        effectiveLabel: 'Final schedule score {value}',
        transientPenaltyLabel: 'Transient penalty {value}',
        slowStreakLabel: 'Slow streak {value}',
        errorStreakLabel: 'Error streak {value}',
        recoverySuccessLabel: 'Recovery success {value}',
        recoveryFastLabel: 'Recovery fast {value}',
        recoveryCreditLabel: 'Recovery credit {value}',
        appliedPenaltyLabel: 'Applied penalty {value}',
        totalRequestsLabel: 'Requests {value}',
        totalRequestsShort: 'Requests',
        failureRequestsLabel: 'Failures {value}',
        ttftSamplesLabel: 'TTFT samples {value}',
        ttftSamplesShort: 'TTFT samples',
        ...
        slowStreakShort: 'Slow streak',
        errorStreakShort: 'Error streak',
        breakdownTitle: 'Base Quality Breakdown',
        recoveryTitle: 'Penalty and Recovery',
        auxiliaryTitle: 'Auxiliary Samples',
        formulaTitle: 'Scheduler Detail',
        ttft5sLabel: '<=5s bonus {value}',
        ttft10sLabel: '5-10s bonus {value}',
        fast5sRateLabel: '<=5s rate {value}',
        fast10sRateLabel: '<=10s rate {value}',
        slow20sRateLabel: '>20s rate {value}',
        slow40sRateLabel: '>40s rate {value}',
        signalFast5s: '<=5s {value}',
        signalSlow10s: '>10s {value}',
        signalErrorRate: 'Errors {value}',
        signalSuccessRate: 'Success {value}',
        signalPenalty: 'Applied penalty {value}',
        signalRecovery: 'Recovery {value}',
        signalAuxWeight: 'Aux weight {value}'
      },
    ...
    accounts: {
      ...
      balanceSync: {
        menuTitle: 'Balance sync configuration',
        title: 'Balance Sync Configuration',
        sites: 'Balance sites',
        siteCount: '{count} sites',
        emptySites: 'No balance sites configured',
        newSite: 'New site',
        refreshAll: 'Refresh all',
        refreshSite: 'Refresh site',
        refreshQueued: 'Balance refresh completed',
        refreshFailed: 'Balance refresh failed',
        loadFailed: 'Failed to load balance sync data',
        platform: 'Platform',
        baseUrl: 'Base URL',
        authMode: 'Auth mode',
        ...
        username: 'Username',
        enabled: 'Enabled for automatic refresh',
        ...
        accessTokenKeepHint: 'leave blank to keep current',
        cookie: 'Cookie',
        cookieConfigured: 'Cookie configured',
        cookieKeepHint: 'leave blank to keep current',
        ...
        bind: 'Bind',
        clearBinding: 'Clear',
        bindingUpdated: 'Balance binding updated',
        bindingCleared: 'Balance binding cleared',
    ...
    usage: {
      ...
      scheduleRecentSuccessRate: 'Recent success',
      scheduleTtft5s: 'First token <= 5s',
      scheduleTtft10s: 'First token <= 10s',
      scheduleTtftGt10s: 'First token > 10s',
      scheduleTtftGt20s: 'First token > 20s',
      scheduleTtftGt40s: 'First token > 40s',
      scheduleQualityScore: 'Quality score',
      scheduleLoadRate: 'Load rate',
      scheduleErrorRate: 'Error rate',
      scheduleSampleConfidence: 'Confidence',
      scheduleFastBonus: 'Fast bonus',
      scheduleSlowPenalty: 'Slow penalty',
      scheduleErrorPenalty: 'Error penalty',
      scheduleNeutralBase: 'Neutral base',
      scheduleFormula: 'Formula',
      scheduleFinalScore: 'Selected score',
      scheduleCandidateScores: 'Candidate score breakdown',
      scheduleSelected: 'Selected',
      scheduleComputedScore: 'Computed score',
      scheduleScoreBreakdown: 'Score breakdown',
      scheduleWaitingCount: 'Waiting',
      scheduleTtftSampleCount: 'TTFT samples',
      scheduleTotalRequests: 'Requests',
      scheduleFailureRequests: 'Failures',
      scheduleStickyEscape: 'Sticky escape',
      scheduleSticky: 'Sticky',
      scheduleRouting: 'Routing',
      ...
      scheduleDecision: {
        ...
        primarySelected: 'Primary account qualified and was selected: {account}',
        primarySkipped: 'Skipped primary account {account}: {reason}',
        stickySelected: 'Matched sticky session: {account}',
        loadBalanceCandidates: 'Load-balance candidate order: {candidates}',
        loadBalanceNoCandidates: 'Entered load-balance selection, but this trace did not record candidate order',
        candidateSelected: '{account} (selected)',
        finalSelected: 'Final selected account: {account}'
      },
      schedulePrimaryBypassReasons: {
        primary_unavailable: 'primary account is currently unavailable',
        primary_not_configured: 'no usable primary account is configured',
        primary_excluded_after_failover: 'this request already excluded the account after a failed retry',
        primary_unschedulable_or_not_found: 'account does not exist, is disabled, or is unschedulable',
