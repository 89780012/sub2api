...
const messages: Record<string, string> = {
  ...
  'usage.selectionMonitor': 'Matched monitor',
  'usage.selectionMonitorPrimaryModel': 'Monitor model',
  'usage.selectionSnapshotAt': 'Selection snapshot',
  'usage.selectionMonitor3': 'Monitor 3',
  'usage.selectionMonitor5': 'Monitor 5',
  'usage.selectionMonitor7': 'Monitor 7',
  'usage.selectionMonitorRecent7': 'Selection-time recent 7',
    ...
    const row = {
      ...
      selection_reason: {
        ...
        monitor_quality: {
          known: true,
          monitor_id: 18,
          monitor_name: 'plus==guguniao-plus-0.085x',
          primary_model: 'gpt-5.4',
          snapshot_at: '2026-03-08T00:07:30Z',
