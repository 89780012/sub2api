...
import { formatSelectionReasonExport } from '@/utils/usageSelectionReason'
  ...
  try {
    ...
    while (true) {
      ...
      const rows = (res.items || []).map((log: AdminUsageLog) => [
        ...
        log.inbound_endpoint || '', log.upstream_endpoint || '', formatSelectionReasonExport(log.selection_reason, t), getRequestTypeLabel(log),
