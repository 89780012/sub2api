...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelMonitorQualityScorer := service.NewChannelMonitorQualityScorer(channelMonitorRepository)
	...
	gatewayService.SetChannelMonitorQualityScorer(channelMonitorQualityScorer)
	...
	openAIGatewayService.SetChannelMonitorQualityScorer(channelMonitorQualityScorer)
