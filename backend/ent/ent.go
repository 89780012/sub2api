...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			accountupstreammonitorrate.Table:     accountupstreammonitorrate.ValidColumn,
			accountupstreammonitorsnapshot.Table: accountupstreammonitorsnapshot.ValidColumn,
