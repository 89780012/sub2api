...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "account_quality_snapshots", "base_quality_score", "double precision", 0, false)
	requireColumn(t, tx, "account_quality_snapshots", "effective_quality_score", "double precision", 0, false)
	requireColumn(t, tx, "account_quality_snapshots", "transient_penalty", "double precision", 0, false)
	requireColumn(t, tx, "account_quality_snapshots", "recovery_credit", "double precision", 0, false)
	requireColumn(t, tx, "account_quality_snapshots", "slow_streak", "bigint", 0, false)
	requireColumn(t, tx, "account_quality_snapshots", "error_streak", "bigint", 0, false)
	requireColumn(t, tx, "account_quality_snapshots", "recovery_success_streak", "bigint", 0, false)
	requireColumn(t, tx, "account_quality_snapshots", "recovery_fast_streak", "bigint", 0, false)
