...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		PrimaryAccountMode:              g.PrimaryAccountMode,
		ManualPrimaryAccountID:          g.ManualPrimaryAccountID,
		ActivePrimaryAccountID:          g.ActivePrimaryAccountID,
		ActivePrimarySource:             g.ActivePrimarySource,
		ActivePrimaryReason:             g.ActivePrimaryReason,
		ActivePrimarySwitchedAt:         g.ActivePrimarySwitchedAt,
		PrimaryFailoverCooldownSeconds:  g.PrimaryFailoverCooldownSeconds,
		PrimaryAllowManualAutoReplace:   g.PrimaryAllowManualAutoReplace,
		RPMLimit:                        g.RPMLimit,
...
func usageScheduleTraceFromService(trace *service.UsageScheduleTrace) *UsageScheduleTrace {
	...
	for _, candidate := range trace.Candidates {
		candidates = append(candidates, UsageScheduleCandidateScore{
			...
			TTFTGT10sRate:     candidate.TTFTGT10sRate,
			TTFTGT20sRate:     candidate.TTFTGT20sRate,
			TTFTGT40sRate:     candidate.TTFTGT40sRate,
			TTFTSampleCount:   candidate.TTFTSampleCount,
			TotalRequests:     candidate.TotalRequests,
			FailureRequests:   candidate.FailureRequests,
			ErrorRate:         candidate.ErrorRate,
			SampleConfidence:  candidate.SampleConfidence,
			FastBonus:         candidate.FastBonus,
			SlowPenalty:       candidate.SlowPenalty,
			ErrorPenalty:      candidate.ErrorPenalty,
			NeutralBase:       candidate.NeutralBase,
	...
	out := &UsageScheduleTrace{
		...
		PrimaryCandidateName: trace.PrimaryCandidateName,
		...
		TTFTGT10sRate:        trace.TTFTGT10sRate,
		TTFTGT20sRate:        trace.TTFTGT20sRate,
		TTFTGT40sRate:        trace.TTFTGT40sRate,
		TTFTSampleCount:      trace.TTFTSampleCount,
		TotalRequests:        trace.TotalRequests,
		FailureRequests:      trace.FailureRequests,
		ErrorRate:            trace.ErrorRate,
		SampleConfidence:     trace.SampleConfidence,
		FastBonus:            trace.FastBonus,
		SlowPenalty:          trace.SlowPenalty,
		ErrorPenalty:         trace.ErrorPenalty,
		NeutralBase:          trace.NeutralBase,
