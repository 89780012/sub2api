...
func TestOpenAIGatewayService_SelectAccountWithScheduler_DefaultDisabledPreservesLegacyTrace(t *testing.T) {
	...
	ctx := context.Background()
	groupID := int64(10107)
	manualPrimaryID := int64(36101)
	secondaryID := int64(36102)
	accounts := []Account{
		{
			ID:          manualPrimaryID,
			Platform:    PlatformOpenAI,
	...
	selection, decision, err := svc.SelectAccountWithScheduler(
		...
		&groupID,
		"",
		"session_hash_default_disabled_primary_excluded",
		"gpt-5.1",
...
func TestOpenAIGatewayService_SelectAccountWithScheduler_DefaultDisabledLoadBatchTraceLayer(t *testing.T) {
	resetOpenAIAdvancedSchedulerSettingCacheForTest()

	ctx := context.Background()
	groupID := int64(10109)
	manualPrimaryID := int64(36201)
	secondaryID := int64(36202)
	accounts := []Account{
		{
			ID:          manualPrimaryID,
			Platform:    PlatformOpenAI,
	...
	selection, decision, err := svc.SelectAccountWithScheduler(
		...
		&groupID,
		"",
		"session_hash_default_disabled_load_batch",
		"gpt-5.1",
		map[int64]struct{}{manualPrimaryID: {}},
		OpenAIUpstreamTransportAny,
		false,
